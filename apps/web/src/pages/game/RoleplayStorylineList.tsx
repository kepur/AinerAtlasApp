  ...
  return (
    ...
    >
      ...
      <main className="flex-1 px-4 pt-4 flex flex-col gap-4">
        ...
        {/* Built-in Story 1 */}
        <div onClick={() => navigate("/game/roleplay/chat?story=qingyun")} className="bg-white/80 backdrop-blur-md rounded-[24px] p-4 shadow-sm border border-white flex flex-col relative cursor-pointer active:scale-[0.98] transition-transform">
        ...
        {/* Built-in Story 2 */}
        <div onClick={() => navigate("/game/roleplay/chat?story=cafe_encounter")} className="bg-white/80 backdrop-blur-md rounded-[24px] p-4 shadow-sm border border-white flex flex-col relative cursor-pointer active:scale-[0.98] transition-transform">
        ...
        {templatesLoading ? (
          ...
          templates.map((tpl) => {
            ...
            return (
              <div 
                key={tpl.id}
                onClick={() => navigate(`/game/roleplay/chat?story=${tpl.id}`)} 
