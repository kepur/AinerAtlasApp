...
// Active Circles have no backend feed yet → placeholders.
// TODO(backend): GET /api/circles?active=true for the user's joined rooms.
const MOCK_CIRCLES = [
    ...
    <div className="premium min-h-full bg-surface text-on-surface">
      ...
      <main className="px-margin-mobile pb-8">
        ...
        <section className="mb-4">
          <h2 className="font-label-sm text-label-sm text-outline mb-4 uppercase tracking-widest">Recent Chats</h2>
      ...
      {/* Mode picker (kept from existing feature) */}
      {showModePicker && (
