...
class GeminiLLMProvider(LLMProvider):
    """LLM provider for Gemini models via the generateContent API."""
    ...
    async def _call_llm(
        ...
        *,
        ...
        try:
            ...
            logger.error("Gemini API error %s: %s", exc.response.status_code, exc)
            raise
